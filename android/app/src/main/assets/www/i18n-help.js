...
const I18N_HELP = {
  ...
  es: {
    ...
    <section>
      <h3>Que no se salga de la app</h3>
      <p>Android trae un modo para dejar una sola app en pantalla. En <b>Ajustes → Seguridad → Fijar apps</b> (o <i>Anclar pantalla</i>, según el teléfono) actívalo y pide el PIN para desanclar.</p>
      <p>Después abre esta app, entra a las apps recientes y toca el ícono de arriba de la tarjeta → <b>Fijar</b>. Para salir, mantén Atrás y Recientes al tiempo.</p>
    </section>

    <section>
      <h3>Sin internet y sin anuncios</h3>
      <p>Esta app <b>no pide permiso de internet</b>. No puede conectarse a ninguna parte aunque quisiera: no hay anuncios, no hay compras, no hay videos de terceros y no sale ni un dato del dispositivo.</p>
      <p>Todo lo que ella dibuja y viste se guarda solo aquí.</p>
    </section>

    <section>
      <h3>Los mundos</h3>
      <p>En <b>Mundos visibles</b> puedes esconder los que no quieras que aparezcan. No se borran: vuelves a marcarlos cuando quieras.</p>
      <p>En <b>Colores de la app</b> cambias los fondos y los botones, por si prefieres una paleta menos rosada. Los dibujos y los personajes no cambian.</p>
    </section>

    <section>
      <h3>Respaldo</h3>
      <p>Todo vive en este dispositivo. Usa <b>Exportar</b> para guardar un archivo con la configuración e <b>Importar</b> para llevarla a otro teléfono o tablet.</p>
    </section>`
  },
  ...
  en: {
    ...
    <section>
      <h3>Keeping her inside the app</h3>
      <p>Android can lock the screen to a single app. Under <b>Settings → Security → App pinning</b> (or <i>Screen pinning</i>, depending on the phone), turn it on and ask for the PIN to unpin.</p>
      <p>Then open this app, go to recent apps, tap the icon at the top of the card → <b>Pin</b>. To leave, hold Back and Recents together.</p>
    </section>

    <section>
      <h3>No internet, no adverts</h3>
      <p>This app <b>asks for no internet permission</b>. It cannot connect anywhere even if it wanted to: no adverts, no purchases, no third-party video, and not one byte leaves the device.</p>
      <p>Everything she draws and dresses up is stored here and only here.</p>
    </section>

    <section>
      <h3>The worlds</h3>
      <p>Under <b>Visible worlds</b> you can hide any you would rather she did not see. They are not deleted — tick them again whenever you like.</p>
      <p>Under <b>App colours</b> you can change the backgrounds and buttons, if you would rather have a less pink palette. The pictures and the characters stay as they are.</p>
    </section>

    <section>
      <h3>Backup</h3>
      <p>Everything lives on this device. Use <b>Export</b> to save a file with the settings and <b>Import</b> to carry it to another phone or tablet.</p>
    </section>`
  },
  ...
  pt: {
    ...
    <section>
      <h3>Para ela não sair do app</h3>
      <p>O Android tem um modo que deixa um app só na tela. Em <b>Configurações → Segurança → Fixar apps</b> (ou <i>Fixação de tela</i>, dependendo do aparelho), ative e peça o PIN para desafixar.</p>
      <p>Depois abra este app, vá aos apps recentes e toque no ícone no topo do cartão → <b>Fixar</b>. Para sair, segure Voltar e Recentes ao mesmo tempo.</p>
    </section>

    <section>
      <h3>Sem internet e sem anúncios</h3>
      <p>Este app <b>não pede permissão de internet</b>. Não consegue se conectar a lugar nenhum nem se quisesse: sem anúncios, sem compras, sem vídeos de terceiros e nenhum dado sai do aparelho.</p>
      <p>Tudo o que ela desenha e veste fica guardado só aqui.</p>
    </section>

    <section>
      <h3>Os mundos</h3>
      <p>Em <b>Mundos visíveis</b> você pode esconder os que não quiser. Eles não são apagados: é só marcar de novo quando quiser.</p>
      <p>Em <b>Cores do app</b> você muda os fundos e os botões, caso prefira uma paleta menos rosa. Os desenhos e os personagens não mudam.</p>
    </section>

    <section>
      <h3>Backup</h3>
      <p>Tudo vive neste aparelho. Use <b>Exportar</b> para salvar um arquivo com as configurações e <b>Importar</b> para levá-lo a outro celular ou tablet.</p>
    </section>`
  }
};
