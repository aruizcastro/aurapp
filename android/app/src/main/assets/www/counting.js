...
const COUNT_ITEMS = [
  { id: 'ball', art: 'los', name: 'balones', draw: () =>
  ...
  { id: 'apple', art: 'las', name: 'manzanas', draw: () =>
  ...
  { id: 'fish', art: 'los', name: 'pececitos', draw: () =>
  ...
  { id: 'butterfly', art: 'las', name: 'mariposas', draw: () =>
