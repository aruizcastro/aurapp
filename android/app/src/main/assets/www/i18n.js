...
const I18N = {
  ...
  es: {
    ...
    'p.help.sub2': 'Los ajustes, el modo de una sola app y el respaldo.',
    ...
    'p.sound.h': 'Sonido',
    'p.sound.on': 'Con sonido',
    'p.sound.note': 'El zumbido de los mosquitos y los sonidos de los juegos. Arranca apagado; enciéndelo aquí si quieres.',
    'p.lang.h': 'Idioma',
  ...
  en: {
    ...
    'p.help.sub2': 'The settings, pinning the app, and backups.',
    ...
    'p.sound.h': 'Sound',
    'p.sound.on': 'Sound on',
    'p.sound.note': 'The mosquitoes\' buzzing and the game sounds. It starts off; turn it on here if you want it.',
    'p.lang.h': 'Language',
  ...
  pt: {
    ...
    'p.help.sub2': 'Os ajustes, o modo de um app só e o backup.',
    ...
    'p.sound.h': 'Som',
    'p.sound.on': 'Com som',
    'p.sound.note': 'O zumbido dos mosquitos e os sons dos jogos. Começa desligado; ligue aqui se quiser.',
    'p.lang.h': 'Idioma',
...
function i18nApply(root) {
  ...
  scope.querySelectorAll('[data-thtml]').forEach(el => {
    // A build without videos gets its own help text. Explaining how to get a
    // YouTube key inside an app that has no videos would confuse the parent
    // and, on a store listing, the reviewer.
    let key = el.getAttribute('data-thtml');
    const pack = I18N_HELP[i18nLang] || I18N_HELP.es;
    if (typeof BUILD !== 'undefined' && !BUILD.videos && pack[key + 'Offline']) key += 'Offline';
    el.innerHTML = pack[key] || I18N_HELP.es[key] || '';
  });
